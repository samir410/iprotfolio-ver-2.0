...
<!-- breadcrumb-area -->
{{-- @php
    $data = App\Models\protfolio::findorfail($id)
@endphp --}}
                    ...
                    <aside class="services__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__contact__info">
                                <li><span>Date :</span>{{$data->created_at}}</li>
                    ...
                    <div class="col-lg-6">
                        <div class="homeContact__form">
                            <form action="{{ route('massage.send') }}" method="post" class="contact__form">
                                ...
                                <input type="email" name="name" placeholder="Enter mail*">
                                <input type="subject" name="subject" placeholder="Enter number*">
                                <input type="budget" name="budget" placeholder="Enter number*">
